# -*- encoding: utf-8 -*-
# stub: autotest 5.0.0 ruby lib

Gem::Specification.new do |s|
  s.name = "autotest".freeze
  s.version = "5.0.0"
  ...
  s.homepage = "http://www.zenspider.com/projects/minitest-autotest.html".freeze
  s.licenses = ["MIT".freeze]
  s.rdoc_options = ["--main".freeze, "README.rdoc".freeze]
  s.rubygems_version = "3.0.3.1".freeze
  s.summary = "This is a stub gem to fix the confusion caused by autotest being part of the ZenTest suite".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<minitest-autotest>.freeze, ["~> 1.0"])
